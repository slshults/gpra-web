...
- **Autocreate chord charts** from lyrics sheets with chord names, existing chord charts, YouTube lesson URLs, or by typing chord names (charts created using Opus 4.7)
